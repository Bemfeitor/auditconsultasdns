    ...
    <DashboardLayout>
      <div className="container py-6 space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
                  ...
                  {rbt12Data.map((item, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium">{item.client.razaoSocialNome}</span>
                      </div>
                      <div className="text-right">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Mensagens e-CAC</CardTitle>
              <CardDescription>
                Confira os status das mensagens e-CAC abaixo e fique atualizado
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-sm text-muted-foreground">
                  Não há mensagens de e-CAC para exibir
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Acompanhe os relatórios fiscais de seus clientes
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                <FileText className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
                <p className="text-sm text-muted-foreground">
                  Não há relatórios fiscais a exibir
                </p>
              </div>
            </CardContent>
          </Card>
